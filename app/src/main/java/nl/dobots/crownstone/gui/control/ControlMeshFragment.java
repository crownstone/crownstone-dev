...
//	private Button   _btnMeshMessage;
	...
	private MeshKeepAlivePacket _meshKeepAlivePacket = new MeshKeepAlivePacket(0);
...
//	}
	...
	void addKeepAliveItem() {
		...
		_meshKeepAlivePacket.addKeepAlive(id, action);
		updateKeepAliveText();
	}
	...
	void setKeepAliveTimeout() {
		...
		_meshKeepAlivePacket.setTimeout(timeout);
		updateKeepAliveText();
	}
	...
	void clearKeepAlive() {
		...
		int timeout = Integer.parseInt(_txtMeshKeepAliveTimeout.getText().toString());
		_meshKeepAlivePacket = new MeshKeepAlivePacket(0);
		updateKeepAliveText();
	}
	...
	void clearMultiSwitch() {
		...
		_meshMultiSwitchPacket = new MeshMultiSwitchPacket();
	...
	void addMultiSwitchItem() {
		...
		_meshMultiSwitchPacket.addMultiSwitch(crownstoneId, switchState, timeout, intent);
		updateMultiSwitchText();
	}
