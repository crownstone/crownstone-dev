 ...
 */
public class ControlActivity extends AppCompatActivity implements ZoomListener {
...
//			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final ProgressDialog dlg = ProgressDialog.show(this, "Connecting", "Please wait...", true, true);
...
//	  	});
	...
	private void initUI() {
		...
		_btnPwmOn = (Button) findViewById(R.id.btnPwmOn);
		...
		_btnPwmOff = (Button) findViewById(R.id.btnPwmOff);
		...
		_btnRelayOn = (Button) findViewById(R.id.btnRelayOn);
		...
		_btnRelayOff = (Button) findViewById(R.id.btnRelayOff);
		...
		_cbPwmEnable = (CheckBox) findViewById(R.id.cbPwmEnable);
		...
		_sbPwm = (SeekBar) findViewById(R.id.sbPwm);
		...
		_txtTemperature = (TextView) findViewById(R.id.txtTemperature);

		_layControl = (RelativeLayout) findViewById(R.id.layControl);
